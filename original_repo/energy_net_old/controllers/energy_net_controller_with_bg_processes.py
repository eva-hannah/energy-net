...
from energy_net_old.market.pricing.cost_types import CostType, calculate_costs
from energy_net_old.dynamics.consumption_dynamics.demand_patterns import DemandPattern, calculate_demand
from energy_net_old.controllers.iso.pricing_strategy import PricingStrategyFactory, QuadraticPricingStrategy
from energy_net_old.controllers.unified_metrics_handler import UnifiedMetricsHandler
from energy_net_old.controllers.pcs.battery_manager import BatteryManager

# Import PCSUnit for full functionality
from energy_net_old.components.pcsunit import PCSUnit
from energy_net_new.energy_dynamcis import EnergyDynamics, ModelBasedDynamics
...
from energy_net_old.model.rewards.cost_reward import CostReward
from energy_net_old.model.rewards.iso_reward import ISOReward
...
class EnergyNetController:
    ...
    def __init__(
        ...
        if self.demand_pattern == DemandPattern.DATA_DRIVEN and self.demand_data_path:
            try:
                from energy_net_old.dynamics.consumption_dynamics.demand_patterns import get_raw_demand_data

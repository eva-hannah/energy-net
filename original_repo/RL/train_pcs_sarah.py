...
def main():
    ...
    if args.eval_only:
        evaluate(args, cost_type, demand_pattern, iso_sequence, pricing_policy)
    else:

        build_directories(args)

        # Build training environment
        pcs_env = build_training_env(args, cost_type, demand_pattern, iso_sequence, pricing_policy)

        # Initialize or load model
        model, prefix = init_or_load_model(args, pcs_env)

        train(args, model, pcs_env, prefix)
...
def train(args, model, pcs_env, prefix):
...
def init_or_load_model(args, pcs_env):
...
def build_training_env(args, cost_type, demand_pattern, iso_sequence, pricing_policy):
...
def evaluate(args, cost_type, demand_pattern, iso_sequence, pricing_policy):
